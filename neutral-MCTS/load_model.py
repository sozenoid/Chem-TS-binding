...
def loaded_model():
    ...
    json_file = open('/home/uccahcl/Chem-TS-binding/train_RNN/model_neutral_clean.json','r')
    ...
    loaded_model.load_weights('/home/uccahcl/Chem-TS-binding/train_RNN/model_neutral_clean.h5')
